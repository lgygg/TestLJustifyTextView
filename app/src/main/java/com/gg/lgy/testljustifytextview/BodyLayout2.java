 ...
 * 2016-11-25
 */
public class BodyLayout2 extends LinearLayout
{
	...
	public BodyLayout2(Context context)
	{
		super(context);
	...
	private void initView()
	{
		...
		if (ll_user != null)
		{
			...
			TextView txt_user = new TextView(_context);
			if (txt_user != null)
			{
		...
		if (ll_password != null)
		{
			...
			TextView txt_password = new TextView(_context);
		...
		if (ll_address != null)
		{
			...
			TextView txt_address = new TextView(_context);
			if (txt_address != null)
			{
		...
		if (ll_phone != null)
		{
			...
			TextView txt_phone = new TextView(_context);
			if (txt_phone != null)
			{
				llParams = new LinearLayout.LayoutParams(Util.dip2px(_context, 80), Util.dip2px(_context, 50));
